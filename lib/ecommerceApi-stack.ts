...
export class ECommerceApiStack extends cdk.Stack {
   ...
   private createOrdersService(props: ECommerceApiStackProps, api: apigateway.RestApi) {
      ...
      //GET /orders
      //GET /orders?email=test@email.com.br.com.br
      //GET /orders?email=test@email.com.br&orderId=123
      ...
      //DELETE /orders?email=test@email.com.br&orderId=123
      ...
      //GET /orders/events?email=test@email.com
      //GET /orders/events?email=test@email.com&eventType=ORDER_CREATED
