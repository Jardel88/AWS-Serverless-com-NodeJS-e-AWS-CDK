import { InvoiceRepository, InvoiceFile } from './layers/invoiceRepository/nodejs/invoiceRepository';
...
async function processRecord(record: S3EventRecord) {
    ...
    try {
        ...
        const sendStatusPromise = invoiceWSService.sendInvoiceStatus(key,
             invoiceTransaction.connectionId, InvoiceTransactionStatus.PROCESSED)
